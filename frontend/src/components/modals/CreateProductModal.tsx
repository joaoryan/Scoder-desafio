        ...
        <>
            ...
            <div className="fixed inset-0 bg-[#282262]/90 backdrop-blur-sm flex items-center justify-center z-50">
                ...
                <form
                    ...
                    className="bg-[#3B328E] p-6 rounded-xl shadow-lg min-h-[472px] w-full max-w-md text-white"
                ...
                >
                    {loading ? (
                        ...
                        :
                        <>
                            <h2 className="text-xl font-bold mb-4">Cadastrar Produto</h2><label className="block mb-3 text-[#CCCCCC]">
                                Nome:
                                <input
                                    type="text"
                                    name="name"
                                    ...
                                    autoComplete="off"
                                    required />
                            </label><label className="block mb-3 text-[#CCCCCC]">
                                Categoria:
                                <input
                                    type="text"
                                    name="category"
                                    ...
                                    autoComplete="off"
                                    required />
                            </label><div className="flex gap-4 mb-3">
                            ...
                            </div><label className="block mb-5 text-[#CCCCCC]">
                                Descrição:
                                <input
                                    type="text"
                                    name="description"
                                    ...
                                    autoComplete="off"
                                    required />
                            </label><div className="flex justify-end gap-4">
                                <button
                                    type="button"
                                    onClick={onClose}
